...
namespace DAL.Tools
{
    public class DBHelper
    {
        ...
        {
            return System.Web.Configuration.WebConfigurationManager.AppSettings["DBConn"].ToString();
        }
        /// <summary> 
        /// 一个有效的数据库连接对象 
        /// </summary> 
        ...
        {
            return ExecuteNonQuery(GetConnSting(), CommandType.Text, commandText, (SqlParameter[])null);
        }
        /// <summary> 
        /// 执行指定类型的SqlCommand. 默认appSetting的connection
        /// </summary> 
        /// <remarks> 
        /// 示例:  
        ...
        {
            return GetDataTable(CommandType.Text, commandText);
        }

        public static DataTable GetDataTable(CommandType ctype, string commandText)
        {
        ...
        public static bool ExecuteSqlsWithTransaction(List<string> sqls)
        {
        ...
        public static string ExecuteScalar(CommandType commandType, string commandText)
        {
            string conn = GetConnSting();
            Object obj = ExecuteScalar(conn, commandType, commandText);
            if (obj == null)
                return "";
            return obj.ToString();
        }
