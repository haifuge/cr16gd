    ...
    public class MenuHelper
    {
        public static string GetMainMenu(int roleId)
        {
            switch (roleId)
            {
                // 公司领导
                case 1:
                    return @"<li id='itemC'><a href='/Companys?mmenu=Companys'><i class='parent-nav-icon icon-waitread'></i><span class='span2'>劳务成分包企业</span></a></li>
                ...
                case 4:
                    // 项目部
                    return @"<li id='itemC'><a href='/Companys'><i class='parent-nav-icon icon-waitread'></i><span class='span2'  id='spanlaowu'>劳务承分包企业</span></a></li>
                            <li id='itemB'><a href='/Projects'><i class='parent-nav-icon icon-meetroom'></i><span>招标内容</span></a></li>
